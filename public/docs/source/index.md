...
<!-- START_fad69b753bc4c89d8bdbb27de68611e2 -->
## api/subscribers/{email?}
> Example request:

```bash
curl -X GET -G "http://localhost/api/subscribers/{email?}" 
```

```javascript
const url = new URL("http://localhost/api/subscribers/{email?}");
...
<!-- END_fad69b753bc4c89d8bdbb27de68611e2 -->
...
```javascript
const url = new URL("http://localhost/api/subscribers");
...
<!-- START_241dc9b638648351aab1b160de27b7fc -->
## api/subscribers
> Example request:

```bash
curl -X PUT "http://localhost/api/subscribers" 
```
...
<!-- END_241dc9b638648351aab1b160de27b7fc -->

<!-- START_a6fb8cc015f39e34f1e8ff9fa7f56e00 -->
## api/subscribers
> Example request:

```bash
curl -X DELETE "http://localhost/api/subscribers" 
```
...
<!-- END_a6fb8cc015f39e34f1e8ff9fa7f56e00 -->
...
<!-- START_48d89c9089f29d51bfc105af2fa05b5d -->
## api/fields/types
> Example request:

```bash
curl -X GET -G "http://localhost/api/fields/types" 
```

```javascript
const url = new URL("http://localhost/api/fields/types");
...
<!-- END_48d89c9089f29d51bfc105af2fa05b5d -->
...
<!-- START_931c4f686c07e172dbb48aa0dc19e1ce -->
## api/fields
> Example request:

```bash
curl -X PUT "http://localhost/api/fields" 
```
...
<!-- END_931c4f686c07e172dbb48aa0dc19e1ce -->

<!-- START_a2d369158df26a7c99a0adf6b1b6b70c -->
## api/fields
> Example request:

```bash
curl -X DELETE "http://localhost/api/fields" 
```
...
<!-- END_a2d369158df26a7c99a0adf6b1b6b70c -->
